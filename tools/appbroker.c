...
static char const * _appbroker_ctype(char const * type)
{
	...
	} ctypes[] =
	{
		...
		{ "UINT8[]", "uint8_t const *", },
		{ "INT16[]", "int16_t const *", },
		{ "UINT16[]", "uint16_t const *", },
		{ "INT32[]", "int32_t const *", },
		{ "UINT32[]", "uint32_t const *", },
		{ "INT64[]", "int64_t const *", },
		{ "UINT64[]", "uint64_t const *", },
		{ "FLOAT[]", "float const *", },
		{ "DOUBLE[]", "double const *", },
		{ "BUFFER[]", "Buffer const **", },
		{ "STRING[]", "String const **", },
		{ "BOOL_IN[]", "bool const *", },
		{ "INT8_IN[]", "int8_t const *", },
		{ "UINT8_IN[]", "uint8_t const *", },
		{ "INT16_IN[]", "int16_t const *", },
		{ "UINT16_IN[]", "uint16_t const *", },
		{ "INT32_IN[]", "int32_t const *", },
		{ "UINT32_IN[]", "uint32_t const *", },
		{ "INT64_IN[]", "int64_t const *", },
		{ "UINT64_IN[]", "uint64_t const *", },
		{ "FLOAT_IN[]", "float const *", },
		{ "DOUBLE_IN[]", "double const *", },
		{ "BUFFER_IN[]", "Buffer const **", },
		{ "STRING_IN[]", "String const **", },
		{ "BOOL_OUT", "bool *", },
		{ "INT8_OUT", "int8_t *", },
